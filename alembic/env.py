...
# The order matters: item must come before loan/reservation (FK targets).
...
# Override the sqlalchemy.url from our settings so it's always in sync.
...
# Set target_metadata so --autogenerate can compare DB vs models.
